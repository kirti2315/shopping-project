...
<div class="container-fluid">
  <a class="navbar-brand" href="index.jsp"><h3><i>Keest</i></h3></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    %>
      <li class="nav-item active dropdown">
       ...
       <li class="nav-item active ml-2">
          <div class="nav-link" >
           <a href="components/aboutus.html"><font color="#fff"><b>About us</b></font></a>
         </div>
      </li>
      
      <li class="nav-item active ml-2">
          <div class="nav-link" >
          <a href="components/contactus.html"><font color="white"><b>Contact us</b></font></a></div>
      </li>
    ...
    <form class="form-inline my-2 my-lg-0" action="ProductOperationServlet" method="post">
      ...
      <button type="submit" class="btn btn-light" style="color:#6c0059"><b>Search</b></button>
    </form>
  ...
  <tbody>
   ...
   %>
    <tr class="text-center">
      ...
      <td class="mid-align"><a href="CartServlet?cartId=<%=c.getCartId()%>&action=delete"><button type="button" class="btn custom-bgg text-white mb-2">Remove</button></a></td>
    </tr>
    <%
      }
    %>
...
<div class="row">
      <form action="OrderServlet" method="post">
          ...
          <input type="submit" class="btn custom-bg text-light"  value="Order">
      </form>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:20px">
          <b>
              Keest Electronics is an internet-based enterprise. Our stores and website offer over 5000 products and more than 200 brands with year-round promotional offers and even No Cost EMI options. Our in-store sales team makes sure to understand every customer's personal needs and budgets while assisting them to make the best choice while buying their tech.
          </b>
        </p>
        </div>
      </div>
