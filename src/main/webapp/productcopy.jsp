                   ...
                   <div class="card-header text-center">
                    ...
                    <div class="text-left ml-3 mt-3"><h2>Description :</h2></div>
                        ...
                        <div class="card-footer text-center">
                                 <p style="font-size:30px"><span style="font-size:30px;"><b>Price :</b></span><span class="ml-2"><b>&#8377;<%=Helper.getProductSellingPrice(product.getProductPrice(), product.getProductDiscount()) %>/-</b></span>
                                 <span class="ml-2" style="font-size:15px;color:black"><s>&#8377;<%=product.getProductPrice()%></s></span>
                                  <span class="ml-2" style="font-size:15px;color:black"><%=product.getProductDiscount() %>&#37 off</span>
                                  <span class="ml-5" style="font-size:15px;">Stock :</span>
                                  <span class="ml-1" style="font-size:15px"><%if(product.getProductQuantity()<1){ %><span style="color:red;"><b><%=stock%></b></span><%} else{ %><%=product.getProductQuantity()%><% } %></span>
                                 </p>
                                 <hr>
