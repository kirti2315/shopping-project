<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%
         ...
         else
         {
             ...
             {
            	 session.setAttribute("message","Users have no access to admin page.");
...
<title>Keest Electronics | Admin</title>
<%@ include file="components/common_cs_js.jsp"%>

<style>
body{
background-image: url(images/keestadmin.jpg);
}
</style>
      ...
      <div class="row mt-3">
           <div class="col-md-4">
                 <div class="card hover" data-toggle="modal" data-target="#show-users-modal">
                     <div class="card-body text-center">
                         <div class="container">
                             <img style="max-width:120px" class="" src="images/users.svg" alt="users_pic" >
                         </div>
                         <h1><%=new UserDaoImp().getTotalUser() %></h1>
                         <h2 class="text-uppercase text-muted">
                         <font style="color:black">Users</font></h2>
                     </div>
                 </div>
           </div>
           ...
           <div class="col-md-4">
                  <div class="card hover" data-toggle="modal" data-target="#show-category-modal">
                     <div class="card-body text-center">
                          <div class="container">
                             <img style="max-width:120px" class="" src="images/users2.svg" alt="users_pic" >
                         </div>
                          <h1><%=new CategoryDaoImp().getTotalCategory() %></h1>
                          <h2 class="text-uppercase text-muted">
                         <font style="color:black">Categories</font></h2>
                     </div>
                 </div>
           </div>
           ...
           <div class="col-md-4">
                  <div class="card hover" data-toggle="modal" data-target="#show-product-modal">
                     <div class="card-body text-center">
                           <div class="container">
                             <img style="max-width:120px" class="" src="images/users3.svg" alt="users_pic" >
                           </div>
                           <h1><%=new ProductDaoImp().getTotalProduct() %></h1>
                           <h2 class="text-uppercase text-muted">
                         <font style="color:black">Products</font></h2>
                     </div>
                 </div>
           </div>
      </div>
      ...
      <div class="row mt-3" >
           <div class="col-md-4">
                 <div class="card hover" data-toggle="modal" data-target="#total-order-modal">
                     <div class="card-body text-center">
                         <div class="container">
                             <img style="max-width:120px" class="" src="images/users4.svg" alt="users_pic" >
                         </div>
                         <h1 class="text-lowercase text-muted"><%=new OrderDaoImp().totalOrdersCount() %></h1>
                         <h2 class="text-uppercase text-muted">
                         <font style="color:black">Orders</font></h2>
                     </div>
                 </div>
           </div>
                  ...
                  <div class="card hover" data-toggle="modal" data-target="#add-category-modal">
                     <div class="card-body text-center">
                          <div class="container md-5">
                             <img style="max-width:120px" class="" src="images/categoryy.svg" alt="users_pic" >
                         </div>
                         <p class="" style="font-size:22px;padding:8.5px">Click to add category</p>
                          <h2 class="text-uppercase text-muted">
                          <font style="color:black">Add Category</font></h2>
                     </div>
                 </div>
           </div>
           ...
           <div class="col-md-4">
                  <div class="card hover" data-toggle="modal" data-target="#add-product-modal">
                     <div class="card-body text-center">
                          ...
                          <p class="" style="font-size:22px; padding:3px">Click to add product</p>
                          <h2 class="text-uppercase text-muted">
                          <font style="color:black">Add Product</font></h2>
                     </div>
                 </div>
           </div>
  ...
  <tbody>
   ...
   %>
    <tr>
      ...
      <td><img style="max-width:70px; max-height:50px" class="img-fluid rounded-circle" src="userProfilePic/<%=u.getUserPic() %>" alt="users_pic" ></td>
